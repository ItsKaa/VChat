...
namespace VChat.Helpers
{
    public static class MessageHelper
    {
        ...
        public static void SendMessageToPeer(long peerId, string channelName, string playerName, string text, string VChatMethodName, params object[] VChatParameters)
        {
            SendMessageToPeer(peerId, channelName, playerName, text, () => ZRoutedRpc.instance.InvokeRoutedRPC(peerId, VChatMethodName, VChatParameters));
        }
        ...
        public static void SendMessageToPeer(long peerId, string channelName, string playerName, string text, Action onVChatInstalledAction)
        {
