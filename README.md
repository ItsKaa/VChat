...
2.1.0
- Changed default command prefix to a dot
- Now always handling forward slash even when the prefix is not set to that, this will only work for VChat clients
- Fixed an exception that occurred when a non VChat client connected
- Updated for game update
- Updated BepInEx to 5.4.1600